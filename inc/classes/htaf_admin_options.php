<?php
    ...
    $opt_name = "htaf_options";

    // This line is only for altering the demo. Can be easily removed.
    $opt_name = apply_filters( 'htaf_options/opt_name', $opt_name );
    ...
    $args = array(
        ...
        'display_name'         => 'Tag a Friend | Options Page',
        ...
        'menu_title'           => __( 'Tag a Friend', 'htaf_phrase' ),
        'page_title'           => __( 'Tag a Friend', 'htaf_phrase' ),
        ...
        'admin_bar_icon'       => 'dashicons-star-filled',
    ...
    $args['admin_bar_links'][] = array(
        'id'    => 'htaf-info',
        'href'  => 'https://github.com/meumairakram/Tag-a-Friend',
        'title' => __( 'Documenation on Github', 'htaf_phrase' ),
    );

    // SHARE ICONS CURRENTLY DISABLED
    ...
    $args['footer_text'] = __( '<p>Made with <3 by <strong>Hasnain Khalid & Umair Akram<strong></p>', 'redux-framework-demo' );
